...
import (
	...
	"github.com/ramblingenzyme/ebookfs/epub/internal/opf"
)
...
// SetCover replaces the image the path already names, which is why replacing a
// cover cannot change its path or its format.
